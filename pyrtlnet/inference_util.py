...
"""``tflite_file_name`` is the name of the quantized saved model file.

This file is generated by ``tensorflow_training.py``, and read by all inference
implementations. It contains the trained model's weights, biases, and quantization
metadata.

"""
tflite_file_name = "quantized.tflite"
